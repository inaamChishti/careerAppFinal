    ...
    <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse offset-md-1" id="sidebarCollapse">
                ...
                <ul class="navbar-nav">
                    <li class="mt-2 nav-item {{ request()->is('user-dashboard') ? 'active' : '' }}" style="background-color: #D361B3;height: 30px; position: relative;">
                        <a class="nav-link" href="{{ url('user-dashboard') }}" style="height: 30px; text-decoration: none;">
                    ...
                    <li class=" mt-2 nav-item {{ request()->is('user-application-form') ? 'active' : '' }}" style="background-color: #D361B3;height: 30px; position: relative;">
                        <a class="nav-link" href="{{url('user-application-form')}}" style="height: 30px;">
                            <i class="fas fa-calendar-alt"></i> Application Form
                        </a>
                    </li>
